...
function Contracts() {
    ...
    const filteredData = filterStatus === "All" ? data1 : data1.filter(d => d.status === filterStatus);
                                ...
                                return (
                                    <div className="flex justify-between items-center gap-[5px] py-5 px-8 border-b border-[#E6EFF5] bg-bgc-3 last:border-b-0" key={index}>
                                        <div className="block flex-[0_0_20%]">
                                            ...
                                            <h4 className="text-[15px] leading-4 font-medium text-content mt-2">{d.contract}</h4>
                                        </div>
                                        <div className="flex-[0_0_20%]">
                                            <p className="text-base leading-[19px] font-normal text-grey-2 mb-2">Guarantee Amount:</p>
                                            <p className="text-[15px] leading-4 font-medium text-content">{d.amount}</p>
                                        </div>
                                        <div className="flex-[0_0_20%]">
                                            <p className="text-base leading-[19px] font-normal text-grey-2 mb-2">Annual Premium:</p>
                                            <p className="text-[15px] leading-4 font-medium text-content">{d.annualPremium}</p>
                                        </div>
                                        <div className="flex-[0_0_20%]">
