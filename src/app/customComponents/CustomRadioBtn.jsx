...
function CustomRadioBtn({icon, title, name, id}) {
  return (
    <div className="flex justify-between border border-[#E6EFF5] bg-bgc-3 py-5 px-[26px] rounded-6 mb-[10px] leading-[54px] items-center">
        <label className="text-base font-normal text-heading flex-auto flex items-center gap-4 cursor-pointer" htmlFor={id}>
            <Image
              src={icon}
              height={24}
              width={24}
        ...
        <input 
          className="relative w-[23px] h-[23px] cursor-pointer accent-[#3876DA]" 
          type="radio" 
          name={name} 
          id={id} 
        />
