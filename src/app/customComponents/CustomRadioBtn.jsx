...
function CustomRadioBtn({icon, title, name, id}) {
  return (
    <div className="flex justify-between border border-[#E6EFF5] bg-bgc-3 py-5 px-[26px] rounded-6 mb-[10px] leading-[54px] items-center cursor-pointer">
        <label className="text-base font-normal text-heading flex-auto flex items-center gap-4" htmlFor={id}>
            <Image
              src={icon}
              height={24}
              width={24}
